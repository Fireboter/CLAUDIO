...
<p style="margin-bottom:1.5rem">Todos los contenidos de este sitio web son propiedad de Bawywear. Queda prohibida su reproducción total o parcial sin autorización expresa.</p>
<h2 style="font-size:1.25rem;font-weight:600;margin-bottom:0.75rem">Responsabilidad</h2>
<p>Bawywear no se hace responsable de los daños que pudieran derivarse del uso de la información contenida en este sitio web.</p>';
?>

...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1.5rem;align-items:start">
  ...
  <div class="admin-form">
    ...
    <div class="form-group">
      <label>Título</label>
      <input type="text" id="nl-title" oninput="updatePreview()" placeholder="¡Novedades en Bawywear!">
    </div>
    <div class="form-group">
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.75rem">
      ...
      <div class="form-group">
        ...
        <input type="text" id="nl-btn-link" oninput="updatePreview()" value="https://www.bawywear.com/shop">
      </div>
    </div>
...
function buildEmailHtml() {
    ...
    <div style="padding:0 24px 8px">
      ...
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:12px">
        ${selectedProducts.map(p => `
          <a href="https://www.bawywear.com/product/${p.id}" style="text-decoration:none;color:#111;display:block">
  ...
  return `<div style="font-family:system-ui,sans-serif;color:#111">
    <div style="background:${SITE_PRIMARY};padding:20px 24px;text-align:center">
      <span style="color:${SITE_ON_PRIMARY};font-size:20px;font-weight:700;letter-spacing:0.1em">BAWYWEAR</span>
    </div>
    ...
    <div style="padding:16px 24px;border-top:1px solid #eee;text-align:center;color:#999;font-size:12px">
      Bawywear · <a href="#" style="color:#999">Darse de baja</a>
    </div>
  </div>`;
}

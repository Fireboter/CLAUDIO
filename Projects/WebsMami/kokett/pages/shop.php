...
<div class="shop-layout">
  ...
  <div>
    <form method="GET" action="/shop" class="shop-search-row">
      <input type="text" name="search" value="<?= e($searchQuery) ?>" placeholder="Buscar productos..." style="flex:1;min-width:0;padding:0.5rem 1rem;border:1px solid var(--color-gray-300);border-radius:4px;font-size:1rem">

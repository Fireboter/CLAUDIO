    ...
    return (
        <div className="space-y-5 text-sm">
            ...
            <div className="space-y-3">
                ...
                <Slider
                    label="Min Slope" sublabel="(0 = off, hides flat lines)"
                    min={0} max={2} step={0.05}
                    value={cfg.minAbsSlope}
                    onChange={v => patch({ minAbsSlope: v })}
                    display={cfg.minAbsSlope === 0 ? 'Off' : `±${cfg.minAbsSlope.toFixed(2)}`}
                />
            </div>
                ...
                <div className={`space-y-3 ${cfg.useNMS ? '' : 'opacity-40 pointer-events-none'}`}>
                    ...
                    <div className="border-t border-slate-700/50 pt-3 space-y-3">
                        ...
                        <Slider
                            ...
                            min={0.0005} max={0.05} step={0.002}
